...
ProductOps Dashboard - A Next.js 16 product and license management dashboard with analytics, pipeline tracking, and license key management. Built with TypeScript, Tailwind CSS v4, and shadcn/ui components.
